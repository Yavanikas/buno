      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-5 px-4 py-5 sm:px-6 lg:flex-row lg:gap-8 lg:px-8 lg:py-8">
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-6 lg:gap-8">
          <header className="flex flex-col gap-6 rounded-[2rem] border border-[#ead9c8] bg-[#fffaf3]/85 p-5 shadow-[0_20px_60px_rgba(76,45,33,0.10)] sm:p-7">
            ...
            <div className="rounded-3xl border border-[#ead9c8] bg-white/60 p-4">
              {isEditingBudget ? (
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <p className="text-sm font-semibold text-[#5d4035]">Budget setup</p>
                    <p className="text-sm text-[#7d6253]">Your monthly budget is active for this demo session.</p>
                  </div>
                  <button
                    className="w-fit rounded-2xl border border-[#d8c3b2] px-4 py-2 text-sm font-bold text-[#5d4035] transition hover:bg-[#f3e6d8]"
                    onClick={() => {
                      setBudgetInput(String(Math.round(monthlyBudget)));
